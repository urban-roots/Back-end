...
const articulos = [
  {
    ...
    autor: "Jairo Severo",
    cuerpo: "",
    sobreElAutor: "Jairo es estudiante de Ánima. Creció entre pantallas y parlantes, y encontró en la música urbana uruguaya el mismo espíritu que lo lleva a construir cosas desde cero: tomar algo de afuera y hacerlo propio.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    autor: "Nicole Silva",
    cuerpo: `<p><strong>Este texto explora el viaje cultural y emocional de la plena,</strong> un ritmo nacido en el Caribe portorriqueño que, desafiando distancias geográficas, se transformó en uno de los pilares de la identidad popular de Uruguay. A través de un recorrido histórico y social, se analiza cómo los sectores obreros rioplatenses adoptaron y moldearon esta música, convirtiéndola en una herramienta de expresión comunitaria viva y en un reflejo de que el arte es, en última instancia, el canal sensorial por el cual los pueblos comunican aquello que las palabras no alcanzan a contener.</strong></p>
    <p>A primera vista, la distancia geográfica y climática entre los cálidos callejones de Ponce, en Puerto Rico, y las frías avenidas invernales de Montevideo, sugeriría un abismo insalvable para cualquier expresión folclórica. Sin embargo, la música posee rutas invisibles que las fronteras no pueden contener. <strong>La plena, nacida a principios del siglo XX como el "periódico cantado" de las clases obreras boricuas, encontró una segunda patria en Uruguay décadas más tarde.</strong> Este fenómeno no fue una mera importación estética o un capricho comercial de las radioemisoras, sino un proceso de asimilación profunda arraigado en las necesidades afectivas de un pueblo que descubrió, en esos compases ajenos, una forma idónea de narrar su propia cotidianidad.</strong></p>
    ...
    <figure>
      <img src="./img/instrumentos.jpg" alt="Cuerda de tambores en el barrio Palermo" />
      <figcaption>
        Cuerda de tambores en el barrio Palermo.
        <cite>Fuente: Intendencia de Montevideo</cite>
      </figcaption>
    </figure>
    <p>Fue en este escenario donde nacieron las orquestas pioneras, verdaderas arquitectas de la identidad tropical uruguaya. <strong>El 28 de febrero de 1964 quedó marcado a fuego con la fundación de la Sonora Borinquen, creada por el maestro Carlos Goberna</strong> quien no solo trajo el rigor de la orquesta típica, sino que con temas icónicos como Elena, Elena o Cometa blanca, convirtió a "la Borinquen" en la agrupación más longeva y respetada, demostrando que la plena era un sentimiento que cruzaba generaciones. Junto a ellos, la irrupción del Conjunto Casino de Ernesto Negrín y la potencia del Combo Camagüey terminaron de consolidar una era dorada. Estas bandas supieron interpretar que la cadencia de la plena dialogaba de igual a igual con las tensiones, alegrías y vicisitudes del trabajador uruguayo. <strong>Al sustituir gradualmente algunos elementos de la percusión original por un sutil patrón del timbal y charleston (dando vida a la popular "plena danza"), e incorporar vientos con un fraseo más melancólico y cercano al tango o al candombe, nació la "plena uruguaya":</strong> una variante única, más pausada, pero cargada de una vibrante energía comunitaria.</p>
    <p>Conectando este desarrollo histórico con su consolidación urbana, los bailes de club de barrio y las fonoplateas se convirtieron en laboratorios sociales. La plena dejó de ser un sonido importado para transformarse en el paisaje sonoro de las barriadas. Los panderos puertorriqueños se fundieron con la sensibilidad charrúa, demostrando que cuando un ritmo es adoptado con tal honestidad, las etiquetas de origen pierden relevancia ante la autenticidad del sentimiento compartido.</p>
